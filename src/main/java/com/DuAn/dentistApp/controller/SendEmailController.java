...
import com.DuAn.dentistApp.model.MailInfo;

import com.DuAn.dentistApp.model.request.PaymentRequest;
...
import com.DuAn.dentistApp.service.service.BillService;
import com.DuAn.dentistApp.service.service.PDFGeneratorService;
import com.DuAn.dentistApp.service.service.UserService;
import com.DuAn.dentistApp.service.service.utils.FileManagerService;
import com.DuAn.dentistApp.service.service.utils.MailerService;
import com.DuAn.dentistApp.utils.MultipartFileUtil;
    ...
    public ResponseEntity<MessageResponse> sendMail(@RequestBody PaymentRequest paymentRequest) {
        ...
        try {
            ...
            if (!users.isEmpty()) {
                ...
                float totalSum = 0f;
                for (com.DuAn.dentistApp.entities.Service invoiceRes : appointmentWithServicesResponseList.getServices()) {
