...
import com.DuAn.dentistApp.repositories.*;
...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public List<AppointmentWithServicesResponse> findAllAppointmentService() {
        ...
        List<com.DuAn.dentistApp.entities.AppointmentService> appointmentServices = appointmentServiceRepository.findAll()
                                                               .stream()
        ...
        Map<Integer, List<com.DuAn.dentistApp.entities.AppointmentService>> appointmentIdToServicesMap = appointmentServices.stream()
        ...
        return appointments.stream()
                       ...
                       .map(appointment -> {
                           List<com.DuAn.dentistApp.entities.AppointmentService> appointmentServicesForAppointment = appointmentIdToServicesMap.getOrDefault(appointment.getAppointmentId(), new ArrayList<>());

                           List<com.DuAn.dentistApp.entities.Service> servicesWithPrices = appointmentServicesForAppointment.stream()
                                                                      .map(appointmentService -> {
                                                                          com.DuAn.dentistApp.entities.Service service = appointmentService.getService();
...
//                                                 .collect(Collectors.toList());
        ...
        Map<Integer, List<com.DuAn.dentistApp.entities.Service>> appointmentIdToServicesMap = appointmentServices.stream()
                                                                                                         .collect(Collectors.groupingBy(
                                                                                                                 appointmentService -> appointmentService.getAppointment().getAppointmentId(),
                                                                                                                 Collectors.mapping(com.DuAn.dentistApp.entities.AppointmentService::getService, Collectors.toList())
                                                                                                         ));
